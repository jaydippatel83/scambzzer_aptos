      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-6 sm:p-8">
          <div className="prose prose-lg sm:prose-xl max-w-none">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mt-12 mb-6"><strong>Copyright Policy</strong></h2>

            <p><strong>Intellectual Property Infringement</strong></p>

            <p>All content, features, and functionality of our services, including but not limited to text, graphics, logos, and software, are the exclusive property of <strong>Scambuzzer(by CodeCrunch Techlabs)</strong> and are protected by international copyright, trademark, and other intellectual property laws.</p>
            ...
            <p>You can contact our copyright agent via email at <a href="mailto:hello@codecrunch.co" className="text-blue-600 hover:text-blue-800">hello@codecrunch.co</a>. Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removing the challenged content from the Service.</p>

            <h2 className="text-2xl sm:text-3xl font-bold mt-12 mb-6"><strong>Intellectual Property</strong></h2>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mt-12 mb-6"><strong>Your Feedback to Us</strong></h2>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mt-12 mb-6"><strong>Links to Other Websites</strong></h2>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mt-12 mb-6"><strong>Termination</strong></h2>

            <p>We may terminate or suspend your Account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach these Terms and Conditions.</p>

            <p>Upon termination, your right to use the Service will cease immediately. If you wish to terminate your Account, you may simply discontinue using the Service.</p>

            <h2 className="text-2xl sm:text-3xl font-bold mt-12 mb-6"><strong>Limitation of Liability</strong></h2>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mt-12 mb-6"><strong>Governing Law</strong></h2>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mt-12 mb-6"><strong>Disputes Resolution</strong></h2>

            <p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>

            <h2 className="text-2xl sm:text-3xl font-bold mt-12 mb-6"><strong>Changes to These Terms and Conditions</strong></h2>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mt-12 mb-6"><strong>Contact Us</strong></h2>

            <p>If you have any questions about these Terms and Conditions, You can contact us:</p>

            <ul className="list-disc pl-6 space-y-2">
              <li>By visiting our website: <a href="https://scambuzzer.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">https://scambuzzer.com/</a></li>
              <li>By sending us an email: <a href="mailto:hello@codecrunch.co" className="text-blue-600 hover:text-blue-800">hello@codecrunch.co</a></li>
            </ul>
          </div>
        </div>
      </div>
